...
export default function IdeaEngineView({
  ...
  return (
    <div id="idea-engine-view" className="space-y-4">
                      ...
                      <td className="p-2 hidden lg:table-cell">
                        ...
                        {idea.source_url ? (
                          <a 
                            ...
                            className="text-[10px] text-emerald-400 hover:underline inline-flex items-center"
                          >
                            Source Link
                          </a>
                        ) : (
                          <span className="text-[10px] text-slate-600">Generated</span>
                        )}
                      </td>
